<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Editar.aspx.cs" Inherits="CRUD_Ativos.Ativos.Editar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12 text-center"><asp:Button runat="server" ID="btnEditar" Text="Cadastrar" OnClick="btnEditar_Click" /></div>
        </div>
    </div>
</asp:Content>
